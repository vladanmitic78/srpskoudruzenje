const translations = {
  'sr-latin': {
    ...
    dashboard: {
      ...
      familyTab: 'Porodica',
      invoicesMobile: 'Fakture',
      trainingsMobile: 'Treninzi',
      documentsMobile: 'Dok.',
      familyMobile: 'Porodica',
      membershipMobile: 'Članstvo',
      personalMobile: 'Profil',
      personalData: {
        fullName: 'Ime i prezime',
      ...
      trainings: {
        ...
        registerFor: 'Prijavi za:',
        myself: 'Sebe',
        child: 'dete',
        registeringFor: 'Prijavljujete:',
        loading: 'Učitavanje treninga...',
        noTrainings: 'Nema zakazanih treninga.',
        youConfirmed: 'Potvrdili ste učešće',
        memberConfirmed: 'Učešće potvrđeno za',
        confirm: 'Potvrdi',
        cancel: 'Otkaži',
        confirmForSelf: 'Da li ste sigurni da želite da potvrdite svoje učešće na',
        confirmForMember: 'Da li ste sigurni da želite da potvrdite učešće za',
        inEvent: 'na',
        confirmSuccess: 'Učešće na treningu potvrđeno! Admin je obavešten.',
        confirmSuccessFor: 'Učešće potvrđeno za',
        cancelReasonPrompt: 'Molimo unesite razlog za otkazivanje učešća na',
        cancelReasonPromptFor: 'Molimo unesite razlog za otkazivanje učešća',
        participationIn: 'učešće na',
        cancelReasonRequired: 'Razlog za otkazivanje je obavezan',
        cancelSuccess: 'Učešće na treningu otkazano. Admin je obavešten.',
    ...
    admin: {
      ...
      documents: {
        ...
        cancel: 'Otkaži',
        loading: 'Učitavanje...',
        orCustom: 'Ili prilagođeno...',
        assignedTo: 'Dodeljeno:',
        download: 'Preuzmi',
        delete: 'Obriši',
        deleteConfirm: 'Da li ste sigurni da želite da obrišete',
        provideFileAndTitle: 'Molimo dodajte fajl i naslov',
        selectUser: 'Molimo izaberite korisnika',
        loadFailed: 'Učitavanje dokumenata nije uspelo',
        uploadSuccess: 'Dokument uspešno otpremljen',
        uploadFailed: 'Otpremanje dokumenta nije uspelo',
  ...
  'sr-cyrillic': {
    ...
    dashboard: {
      ...
      familyTab: 'Породица',
      invoicesMobile: 'Фактуре',
      trainingsMobile: 'Тренинзи',
      documentsMobile: 'Док.',
      familyMobile: 'Породица',
      membershipMobile: 'Чланство',
      personalMobile: 'Профил',
      personalData: {
        fullName: 'Име и презиме',
      ...
      trainings: {
        ...
        registerFor: 'Пријави за:',
        myself: 'Себе',
        child: 'дете',
        registeringFor: 'Пријављујете:',
        loading: 'Учитавање тренинга...',
        noTrainings: 'Нема заказаних тренинга.',
        youConfirmed: 'Потврдили сте учешће',
        memberConfirmed: 'Учешће потврђено за',
        confirm: 'Потврди',
        cancel: 'Откажи',
        confirmForSelf: 'Да ли сте сигурни да желите да потврдите своје учешће на',
        confirmForMember: 'Да ли сте сигурни да желите да потврдите учешће за',
        inEvent: 'на',
        confirmSuccess: 'Учешће на тренингу потврђено! Админ је обавештен.',
        confirmSuccessFor: 'Учешће потврђено за',
        cancelReasonPrompt: 'Молимо унесите разлог за отказивање учешћа на',
        cancelReasonPromptFor: 'Молимо унесите разлог за отказивање учешћа',
        participationIn: 'учешће на',
        cancelReasonRequired: 'Разлог за отказивање је обавезан',
        cancelSuccess: 'Учешће на тренингу отказано. Админ је обавештен.',
    ...
    admin: {
      ...
      documents: {
        ...
        cancel: 'Откажи',
        loading: 'Учитавање...',
        orCustom: 'Или прилагођено...',
        assignedTo: 'Додељено:',
        download: 'Преузми',
        delete: 'Обриши',
        deleteConfirm: 'Да ли сте сигурни да желите да обришете',
        provideFileAndTitle: 'Молимо додајте фајл и наслов',
        selectUser: 'Молимо изаберите корисника',
        loadFailed: 'Учитавање докумената није успело',
        uploadSuccess: 'Документ успешно отпремљен',
        uploadFailed: 'Отпремање документа није успело',
  ...
  'en': {
    ...
    dashboard: {
      ...
      familyTab: 'Family',
      invoicesMobile: 'Bills',
      trainingsMobile: 'Events',
      documentsMobile: 'Docs',
      familyMobile: 'Family',
      membershipMobile: 'Info',
      personalMobile: 'Profile',
      personalData: {
        fullName: 'Full Name',
      ...
      trainings: {
        ...
        youConfirmed: 'You confirmed participation',
        memberConfirmed: 'Participation confirmed for',
        confirm: 'Confirm',
        cancel: 'Cancel',
        confirmForSelf: 'Are you sure you want to confirm your participation in',
        confirmForMember: 'Are you sure you want to confirm participation for',
        inEvent: 'in',
        confirmSuccess: 'Training participation confirmed! Admin has been notified.',
        confirmSuccessFor: 'Participation confirmed for',
        cancelReasonPrompt: 'Please provide a reason for cancelling your participation in',
        cancelReasonPromptFor: 'Please provide a reason for cancelling',
        participationIn: 'participation in',
        cancelReasonRequired: 'Cancellation reason is required',
        cancelSuccess: 'Training participation cancelled. Admin has been notified.',
    ...
    admin: {
      ...
      documents: {
        ...
        provideFileAndTitle: 'Please provide a file and title',
  ...
  'sv': {
    ...
    dashboard: {
      ...
      familyTab: 'Familj',
      invoicesMobile: 'Fakturor',
      trainingsMobile: 'Träning',
      documentsMobile: 'Dok.',
      familyMobile: 'Familj',
      membershipMobile: 'Medlemskap',
      personalMobile: 'Profil',
      personalData: {
      ...
      trainings: {
        ...
        registerFor: 'Registrera för:',
        myself: 'Mig själv',
        child: 'barn',
        registeringFor: 'Du registrerar för:',
        loading: 'Laddar träningar...',
        noTrainings: 'Inga träningar schemalagda.',
        youConfirmed: 'Du har bekräftat deltagande',
        memberConfirmed: 'Deltagande bekräftat för',
        confirm: 'Bekräfta',
        cancel: 'Avboka',
        confirmForSelf: 'Är du säker på att du vill bekräfta ditt deltagande i',
        confirmForMember: 'Är du säker på att du vill bekräfta deltagande för',
        inEvent: 'i',
        confirmSuccess: 'Träningsdeltagande bekräftat! Admin har meddelats.',
        confirmSuccessFor: 'Deltagande bekräftat för',
        cancelReasonPrompt: 'Ange anledning till avbokning av ditt deltagande i',
        cancelReasonPromptFor: 'Ange anledning till avbokning av',
        participationIn: 'deltagande i',
        cancelReasonRequired: 'Anledning till avbokning krävs',
        cancelSuccess: 'Träningsdeltagande avbokat. Admin har meddelats.',
    ...
    admin: {
      ...
      documents: {
        ...
        cancel: 'Avbryt',
        loading: 'Laddar...',
        orCustom: 'Eller anpassad...',
        assignedTo: 'Tilldelad till:',
        download: 'Ladda ner',
        delete: 'Radera',
        deleteConfirm: 'Är du säker på att du vill radera',
        provideFileAndTitle: 'Vänligen ange en fil och titel',
        selectUser: 'Vänligen välj en användare',
        loadFailed: 'Det gick inte att ladda dokument',
        uploadSuccess: 'Dokumentet har laddats upp',
        uploadFailed: 'Det gick inte att ladda upp dokumentet',
      ...
      events: {
        ...
        by: 'av',
        attended: 'närvarande',
        confirmedList: 'Bekräftade',
        rejectedList: 'Avböjda',
