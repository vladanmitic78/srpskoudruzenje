  ...
  'sr-latin': {
    ...
    admin: {
      ...
      family: {
        ...
        addSuccess: 'Član porodice uspešno dodat! Pristupni podaci poslati na email.',
      ...
      events: {
        ...
        cancelEvent: 'Otkaži',
        attendance: 'Prisustvo / Attendance',
  ...
  'sr-cyrillic': {
    ...
    admin: {
      ...
      events: {
        ...
        cancelEvent: 'Откажи',
        attendance: 'Присуство / Attendance',
  ...
  'en': {
    ...
    admin: {
      ...
      family: {
        ...
        addSuccess: 'Family member added successfully! Login credentials sent to their email.',
